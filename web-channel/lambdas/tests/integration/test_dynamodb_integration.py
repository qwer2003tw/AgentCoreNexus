...
def test_websocket_connect_saves_to_dynamodb(aws_environment, test_user_with_binding, valid_jwt_token):
...
def test_conversations_crud_operations_with_dynamodb(aws_environment, test_user_with_binding):
    ...
    from default import create_new_conversation, auto_assign_conversation_id
