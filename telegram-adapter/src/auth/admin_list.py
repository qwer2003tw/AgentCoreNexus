    ...
    try:
        ...
        if "Item" not in response:
            logger.debug(
                ...
                extra={"chat_id": chat_id, "username": username, "event_type": "user_not_found"},
            )
            return "none"
        ...
        if not item.get("enabled", False):
            logger.debug(
                "User is disabled",
                extra={"chat_id": chat_id, "username": username, "event_type": "user_disabled"},
            )
            return "none"
        ...
        logger.error(
            ...
            extra={"chat_id": chat_id, "username": username, "event_type": "role_retrieval_error"},
            exc_info=True,
        )
        return "none"
