...
from src.sqs_client import send_to_queue, get_queue_attributes
...
class TestSQSClient:
    ...
    @patch('src.sqs_client.queue_url', 'https://sqs.us-east-1.amazonaws.com/123456789/telegram-inbound')
    ...
    def test_send_message_success(self, mock_sqs, sample_message):
        ...
        assert call_args[1]['QueueUrl'] == 'https://sqs.us-east-1.amazonaws.com/123456789/telegram-inbound'
    ...
    def test_get_queue_attributes_failure(self, mock_sqs):
        ...
        mock_sqs.get_queue_attributes.side_effect = ClientError(error_response, 'GetQueueAttributes')
