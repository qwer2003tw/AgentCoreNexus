...
import pytest
import json
from src.telegram_client import redact_sensitive_data, _redact_path
...
class TestRedactSensitiveData:
    ...
    def test_redact_list_value(self):
        ...
        assert result['multiValueHeaders']['X-Telegram-Bot-Api-Secret-Token'] == ['[REDACTED]', '[REDACTED]']
    ...
    def test_redact_multiple_fields(self):
        ...
        data = {
            ...
            'multiValueHeaders': {
                'X-Telegram-Bot-Api-Secret-Token': ['secret456']
            },
            'requestContext': {
                'accountId': '123456789012'
            }
