...
def create_response(
    ...
    """
    default_headers = {"Content-Type": "application/json", "X-Service": "telegram-lambda"}
...
def success_response(data: dict[str, Any], message: str = "Success") -> dict[str, Any]:
    ...
    Returns:
        dict: 200 OK 回應
    """
    return create_response(200, {"success": True, "message": message, "data": data})


def error_response(
    status_code: int, error_message: str, error_code: str | None = None
) -> dict[str, Any]:
    """
    建立錯誤回應
