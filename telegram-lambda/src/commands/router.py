...
class CommandRouter:
    ...
    def register(self, handler: CommandHandler) -> None:
        ...
        if not isinstance(handler, CommandHandler):
            raise TypeError(
                f"Handler must be an instance of CommandHandler, got {type(handler).__name__}"
            )
        ...
        logger.info(
            ...
            extra={"handler_name": handler.get_command_name(), "event_type": "handler_registered"},
        )
    ...
    def route(self, update: Update, event: dict) -> bool:
        ...
        if not message or not message.text:
            logger.debug("No text message to route", extra={"event_type": "route_no_text"})
            return False
        ...
        logger.debug(
            ...
            extra={"chat_id": chat_id, "message_text": text, "event_type": "route_no_match"},
        )
        return False
