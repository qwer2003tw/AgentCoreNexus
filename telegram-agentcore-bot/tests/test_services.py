...
class TestMemoryService(unittest.TestCase):
    ...
    def test_extract_actor_id_from_headers(self, mock_settings):
        ...
        mock_context = Mock()
        mock_context.headers = {"X-Amzn-Bedrock-AgentCore-Runtime-Custom-Actor-Id": "custom_user"}
    ...
    def test_create_memory_config(self, mock_settings):
        ...
        service._create_memory_config("session-123", "user-456")
...
class TestBrowserService(unittest.TestCase):
    ...
    def test_format_result(self):
        """測試格式化結果"""
        service = BrowserService(region="us-west-2")
        result = service._format_result("https://example.com", "測試標題", "測試內容")
...
class TestServicesModule(unittest.TestCase):
    ...
    def test_module_imports(self):
        """測試模組可以正確導入"""
        from services import BrowserService, MemoryService
